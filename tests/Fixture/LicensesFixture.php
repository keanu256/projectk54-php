...
class LicensesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'license_type' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'license_type' => 1,
            'expired' => '2018-05-01 22:07:13',
            'updated' => 1525187233,
            'created' => '2018-05-01 22:07:13'
        ],
    ];
}
