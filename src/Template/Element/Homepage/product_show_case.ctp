	...
	<section class="product-showcase">
		...
		<ul id="owl-bs-products" class="product-list grid owl-carousel">
			...
			<li class="list-item">
				...
				<div class="actions">
					<figure class="liquid">
						<?= $this->Html->image('/homepage/images/items/33.png') ?>
					</figure>
					<div>
			...
			<li class="list-item">
				...
				<div class="actions">
					<figure class="liquid">
						<?= $this->Html->image('/homepage/images/items/25.png') ?>
					</figure>
					<div>
			...
			<li class="list-item">
				...
				<div class="actions">
					<figure class="liquid">
						<?= $this->Html->image('/homepage/images/items/04.png') ?>
					</figure>
					<div>
			...
			<li class="list-item">
				...
				<div class="actions">
					<figure class="liquid">
						<?= $this->Html->image('/homepage/images/items/07.png') ?>
					</figure>
					<div>
			...
			<li class="list-item">
				...
				<div class="actions">
					<figure class="liquid">
						<?= $this->Html->image('/homepage/images/items/37.png') ?>
					</figure>
					<div>
