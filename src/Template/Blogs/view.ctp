    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-8 text-left">
                ...
                <h1 class="font-weight-bold text-6">Morbi velex faucibus ultrices magna accumsan</h1>
                    ...
                    <div id="togglePopularPosts" class="accordion-body collapse show" aria-labelledby="popularPosts">
                        <div class="card-body">
                            ...
                            <article class="row align-items-center mb-3">
                                <div class="col-4 pr-0">
                                    <a href="blog-single-post.html">
                                        <img src="/homepage/img/blog/posts/post-1-square.jpg" class="img-fluid hover-effect-2" alt="" />
                                    </a>
                                </div>
                                <div class="col-8">
                            ...
                            <article class="row align-items-center mb-3">
                                <div class="col-4 pr-0">
                                    <a href="blog-single-post.html">
                                        <img src="/homepage/img/blog/posts/post-2-square.jpg" class="img-fluid hover-effect-2" alt="" />
                                    </a>
                                </div>
                                <div class="col-8">
                            ...
                            <article class="row align-items-center mb-3">
                                <div class="col-4 pr-0">
                                    <a href="blog-single-post.html">
                                        <img src="/homepage/img/blog/posts/post-3-square.jpg" class="img-fluid hover-effect-2" alt="" />
                                    </a>
                                </div>
                                <div class="col-8">
                ...
                <div class="card-body p-4 my-3">
                    <div class="icon-box icon-box-style-1 align-items-center mb-0">
                        <div class="icon-box-icon pr-2">
                            <img width="60" src="/homepage/img/icons/envelope.svg" alt="" data-icon data-plugin-options="{'color': '#FFF'}" />
                        </div>
        ...
        <div class="col-md-8 col-lg-9 order-1 mb-5 mb-md-0">
            <article class="blog-post mb-4">
                ...
                <header class="blog-post-header mb-3">
                    <img src="/homepage/img/blog/generic/blog-18.jpg" class="img-fluid" alt="" />
                </header>
                ...
                <div class="col">
                    ...
                    <div class="icon-box icon-box-style-1 align-items-center mt-3">
                        <div class="icon-box-icon">
                            <img src="/homepage/img/authors/author-1.jpg" class="img-fluid rounded-circle mr-2" alt="" />
                        </div>
                        <div class="icon-box-info">
                            <div class="icon-box-info-title">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <a href="blog-single-post.html">
                        <div class="card card-style-5 bg-light-5 rounded border-0 p-3" data-plugin-image-background data-plugin-options="{'imageUrl': '/homepage/img/blog/posts/post-1-square.jpg'}">
                            <div class="card-body p-4">
                                ...
                                <p class="text-color-dark font-weight-semibold mb-0">
                                    <img src="/homepage/img/authors/author-1.jpg" class="img-thumbnail-small rounded-circle d-inline-block mr-2" width="25" height="25" alt="" />
                                    by Bob Doe
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <a href="blog-single-post.html">
                        <div class="card card-style-5 bg-light-5 rounded border-0 p-3" data-plugin-image-background data-plugin-options="{'imageUrl': '/homepage/img/blog/posts/post-2-square.jpg'}">
                            <div class="card-body p-4">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                <p class="text-color-dark font-weight-semibold mb-0">
                                    <img src="/homepage/img/authors/author-2.jpg" class="img-thumbnail-small rounded-circle d-inline-block mr-2" width="25" height="25" alt="" />
                                    by John Doe
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <a href="blog-single-post.html">
                        <div class="card card-style-5 bg-light-5 rounded border-0 p-3" data-plugin-image-background data-plugin-options="{'imageUrl': '/homepage/img/blog/posts/post-3-square.jpg'}">
                            <div class="card-body p-4">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                <p class="text-color-dark font-weight-semibold mb-0">
                                    <img src="/homepage/img/authors/author-3.jpg" class="img-thumbnail-small rounded-circle d-inline-block mr-2" width="25" height="25" alt="" />
                                    by Jessica Doe
                                </p>
                            </div>
                        </div>
                        ...
                        <li>
                            <div class="comment">
                                <div class="d-none d-sm-block">
                                    <img class="avatar rounded-circle" alt="" src="/homepage/img/authors/author-2.jpg">
                                </div>
                            ...
                            <ul class="comments reply">
                                <li>
                                    <div class="comment">
                                        <div class="d-none d-sm-block">
                                            <img class="avatar rounded-circle" alt="" src="/homepage/img/authors/author-3.jpg">
                                        </div>
                                        <div class="comment-block">
                                            <span class="comment-by">
                                ...
                                <li>
                                    <div class="comment">
                                        <div class="d-none d-sm-block">
                                            <img class="avatar rounded-circle" alt="" src="/homepage/img/authors/author-1.jpg">
                                        </div>
                                        <div class="comment-block">
                                            <span class="comment-by">
