        ...
        n = function(t, e) {
            ...
            t.addButton("emoticons", {
                ...
                panel: {
                    ...
                    html: i,
                    onclick: function(e) {
                        var i, o, n, a = t.dom.getParent(e.target, "a");
                        a && (i = t, o = a.getAttribute("data-mce-url"), n = a.getAttribute("data-mce-alt"), i.insertContent(i.dom.createHTML("img", { src: o, alt: n })), this.hide())
                    }
                },
                tooltip: "Emoticons"
            })
        };
    t.add("emoticons", function(t, e) { n(t, e) })
}();